 ...
 *
 * Không cần MySQL — SQLite local.
 * Mọi query dùng PreparedStatement.
 */
public class DatabaseManager {
    ...
    public void init() throws Exception {
        ...
        // Extract native SQLite lib vào thư mục plugin (tránh /tmp bị chặn)
    ...
    /**
     * Validate code, return result nếu còn hạn, luôn xóa code (one-time use).
     */
